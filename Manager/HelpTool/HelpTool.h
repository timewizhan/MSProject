...
public:
	...
	typedef std::vector<DWORD>	VecPID;
	DWORD	GetAllProcessID(VecPID &refVecPID);

	DWORD	TerminateProcessByPID(DWORD dwPID);
	DWORD	TerminateProcessByALLPID(VecPID &refVecPID);
};
